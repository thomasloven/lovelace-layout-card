...
var ContentRect_2 = ContentRect;


var ContentRect_1 = /*#__PURE__*/Object.defineProperty({
	ContentRect: ContentRect_2
...
var ResizeObservation_2 = ResizeObservation;


var ResizeObservation_1 = /*#__PURE__*/Object.defineProperty({
	ResizeObservation: ResizeObservation_2
}, '__esModule', {value: true});
...
var ResizeObserverEntry_2 = ResizeObserverEntry;


var ResizeObserverEntry_1 = /*#__PURE__*/Object.defineProperty({
	ResizeObserverEntry: ResizeObserverEntry_2
}, '__esModule', {value: true});
...
var ResizeObserver_2 = ResizeObserver;
...
class BaseLayout extends LitElement {
    ...
    async setConfig(config) {
        ...
        for (const card of this._config.cards) {
            if (typeof ((_a = card.layout) === null || _a === void 0 ? void 0 : _a.show) !== "string" &&
                ((_c = (_b = card.layout) === null || _b === void 0 ? void 0 : _b.show) === null || _c === void 0 ? void 0 : _c.mediaquery)) {
        ...
        this._observer = new ResizeObserver_2(() => {
            this._updateSize();
        });
    }
    async updated(changedProperties) {
        ...
        if (changedProperties.has("hass") &&
            ((_a = changedProperties.get("hass")) === null || _a === void 0 ? void 0 : _a.dockedSidebar) != this.hass.dockedSidebar)
            this._updateSize();
    }
    async firstUpdated() {
        var _a, _b, _c, _d;
        this._updateSize();
        const column_max_width = ((_a = this._config.layout) === null || _a === void 0 ? void 0 : _a.max_width) || ((_b = this._config.layout) === null || _b === void 0 ? void 0 : _b.width)
            ? Math.ceil(((_c = this._config.layout) === null || _c === void 0 ? void 0 : _c.width) * 1.5)
            : 500;
        const column_two_width = ((_d = this._config.layout) === null || _d === void 0 ? void 0 : _d.width)
    ...
    async _updateSize() {
        ...
        let colnum = 0;
        colnum = Math.floor(width / (((_a = this._config.layout) === null || _a === void 0 ? void 0 : _a.width) || 300));
        colnum = Math.min(colnum, ((_b = this._config.layout) === null || _b === void 0 ? void 0 : _b.max_cols) || ((_c = this.hass) === null || _c === void 0 ? void 0 : _c.dockedSidebar) === "docked"
            ? 3
            : 4);
    ...
    _filterCards(card, index) {
        var _a, _b;
        if (((_a = card.config.layout) === null || _a === void 0 ? void 0 : _a.show) === "always")
            return true;
        if (((_b = card.config.layout) === null || _b === void 0 ? void 0 : _b.show) === "never")
            return false;
    ...
    async _placeColumnCards(cols, cards) { }
    render() {
...
__decorate([
    property()
], BaseLayout.prototype, "cards", void 0);
__decorate([
    property()
], BaseLayout.prototype, "index", void 0);
__decorate([
    property()
], BaseLayout.prototype, "_columns", void 0);
__decorate([
    property()
], BaseLayout.prototype, "narrow", void 0);
__decorate([
    property()
], BaseLayout.prototype, "hass", void 0);
__decorate([
    property()
], BaseLayout.prototype, "_config", void 0);
__decorate([
    property()
], BaseLayout.prototype, "lovelace", void 0);
__decorate([
    _default
], BaseLayout.prototype, "_filterCards", null);

class MasonryLayout extends BaseLayout {
    async _placeColumnCards(cols, cards) {
        var _a;
        const min_height = ((_a = this._config.layout) === null || _a === void 0 ? void 0 : _a.min_height) || 5;
        function shortestCol() {
            let i = 0;
            for (let j = 0; j < cols.length; j++) {
                if (cols[j].length && cols[j].length < min_height)
                    return cols[j];
...
class HorizontalLayout extends BaseLayout {
    async _placeColumnCards(cols, cards) {
        ...
        for (const c of cards) {
            ...
            if ((_a = c.config.layout) === null || _a === void 0 ? void 0 : _a.column)
                i = c.config.layout.column;
    ...
    async updated(changedProperties) {
        if (changedProperties.has("cards")) {
            ...
            for (const [index, card] of this.cards.entries()) {
                ...
                for (const [key, value] of Object.entries((cardConfig === null || cardConfig === void 0 ? void 0 : cardConfig.layout) || {})) {
...
__decorate([
    property()
], GridLayout.prototype, "cards", void 0);
__decorate([
    property()
], GridLayout.prototype, "index", void 0);
__decorate([
    property()
], GridLayout.prototype, "narrow", void 0);
__decorate([
    property()
], GridLayout.prototype, "hass", void 0);
__decorate([
    property()
], GridLayout.prototype, "_config", void 0);
...
class LayoutCard extends LitElement {
    ...
    setConfig(config) {
        var _a;
        this._config = Object.assign({}, config);
        let configType = (_a = config.layout) === null || _a === void 0 ? void 0 : _a.type;
        if (configType) {
            if (!(configType === null || configType === void 0 ? void 0 : configType.endsWith("-layout")))
                configType += "-layout";
    ...
    async updated(changedProperties) {
        ...
        if (changedProperties.has("_layoutType") ||
            changedProperties.has("_config")) {
            const viewConfig = {
                type: this._layoutType,
                layout: (_a = this._config.layout) === null || _a === void 0 ? void 0 : _a.layout,
                cards: this._config.cards,
            };
            if (!this._layoutElement) {
                const layoutElement = document.createElement(this._layoutType);
            ...
            this._layoutElement.lovelace = Object.assign(Object.assign({}, this._getLovelace()), { editMode: false });
    ...
    _getLovelace(el = this) {
        if (el.lovelace)
            return el.lovelace;
        if (el.localName === "home-assistant")
            return undefined;
        if (el.parentElement && el.parentElement.host)
            return this._getLovelace(el.parentElement.host);
        if (el.parentNode && el.parentNode.host)
            return this._getLovelace(el.parentNode.host);
        if (el.parentElement)
            return this._getLovelace(el.parentElement);
        if (el.parentNode)
            return this._getLovelace(el.parentNode);
    }
    _createCard(cardConfig, cardHelpers) {
    ...
    async _rebuildCard(el, cardConfig) {
        const cardHelpers = await window.loadCardHelpers();
...
__decorate([
    property()
], LayoutCard.prototype, "hass", void 0);
__decorate([
    property()
], LayoutCard.prototype, "editMode", void 0);
__decorate([
    property()
], LayoutCard.prototype, "isPanel", void 0);
__decorate([
    property()
], LayoutCard.prototype, "_config", void 0);
__decorate([
    property()
], LayoutCard.prototype, "_cards", void 0);
__decorate([
    property()
], LayoutCard.prototype, "_layoutElement", void 0);
__decorate([
    property()
], LayoutCard.prototype, "_layoutType", void 0);
customElements.define("layout-card", LayoutCard);

var name = "layout-card";
var version = "2.0.0b0";
var description = "";
var scripts = {
	build: "rollup -c",
...
console.info(`%cLAYOUT-CARD ${pjson.version} IS INSTALLED`, "color: green; font-weight: bold", "");
